...
I know... it's a **hook** but it's under **Components**?! It's because this hook returns a Panel component, and that's the panel component you should use in your JSX (instead of import the Panel component from UI Fabric).
...
() => {
  ...
  let { panelProps, openPanel, closePanel, isOpen } = usePanel({ size: 900 });
