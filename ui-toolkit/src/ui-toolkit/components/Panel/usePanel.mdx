...
I know... it's a hook but it's under "Components"?! It's because this hook returns a Panel component, and that's the panel component you should use in your JSX.
